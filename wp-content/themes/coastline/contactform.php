...
<form class="form form-horizontal" method="post" action="#quick-contact-form" >
	<div class="row">
		<div class="col-sm-6 col-md-4" >
			<div class="form-group">
				<input type="text" class="form-control input-underline fullname <?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && $_POST && $_POST['fullname'] == ''){ echo 'has-error'; } ?>" placeholder="Name" name="fullname" value="<?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && !$passCheck){ echo $_POST['fullname']; } ?>" required >
			</div>
		</div>
		<div class="col-sm-6 col-md-4" >
			<div class="form-group">
				<input type="text" id="txtPhone" class="form-control input-underline phonenum <?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && $_POST && $_POST['phonenum'] == ''){ echo 'has-error'; } ?>" placeholder="Phone" name="phonenum" value="<?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && !$passCheck){ echo $_POST['phonenum']; } ?>" required >
			</div>
		</div>
		<div class="col-md-4" >
			<div class="form-group">
				<input type="text" class="form-control input-underline emailaddr <?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && $_POST && ($_POST['emailaddr'] == '' || $emailFormattedBadly )){ echo 'has-error'; } ?>" placeholder="Email" name="emailaddr" value="<?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && !$passCheck){ echo $_POST['emailaddr']; } ?>" required>
			</div>
		</div>
		<div class="col-xs-12">
			<div class="form-group">
				<textarea name="contactmessage" class="form-control input-outline contactmessage" placeholder="Message..." ><?php if($_POST['secu'] == '' && $_POST['form_id'] == 'quick-contact' && !$passCheck){ echo $_POST['contactmessage']; } ?></textarea>
			</div>
			<div class="form-group">
