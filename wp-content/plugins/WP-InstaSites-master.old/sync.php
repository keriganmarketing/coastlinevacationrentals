		...
		public static function getMustache($entity, $pkid, $c=false) {
			...
			if (!empty($sitesettings)) {
				...
				if (!empty($hasreviews)){
					...
					$hasreviews = str_split('[=;]', $hasreviews);
				...
				if (!empty($displayavailcalendar)){
					$displayavailcalendar = str_split('[=;]', $displayavailcalendar);
				...
				if (!empty($hiderateavailtab)){
					$hiderateavailtab = str_split('[=;]', $hiderateavailtab);
				...
				if (!empty($hidestarsreviews)){
					$hidestarsreviews = str_split('[=;]', $hidestarsreviews);
					/* we assign the value to var in the config array */
				...
				if (!empty($hideratestable)){
					$hideratestable = str_split('[=;]', $hideratestable);
					/* we assign the value to var in the config array */
