...
function search_page_sc(){
	$d = '<div id="results" class="bapi-summary loading" data-log="0" data-defaultsearchresultview="1" data-templatename="tmpl-propertysearch-listview" data-entity="property" data-applyfixers="1" data-rowfixselector=".gallery-view-page%20%3E%20.span6" data-rowfixcount="2" data-showallresults="1"></div>';	
	return $d;
}
