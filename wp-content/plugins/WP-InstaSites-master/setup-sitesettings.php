...
if(!$bapi->isvalid()) {
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {	
		...
		if('Descending' == $sitesettings_raw['searchsortorder']) {
...
<tr valign="top">
	...
	<td>
		<input name="settingsRaw[searchsort]" type="hidden" value="<?php echo $sitesettings_raw['searchsort']; ?>" />
		...
		<select name="searchsortorder" id="searchsortorder">
			<option value="BAPI.config().sortdesc=false;" <?php echo ($settings['searchsortorder'] == "Ascending" ? 'selected=true"' : ''); ?> >Ascending</option>
			<option value="BAPI.config().sortdesc=true;" <?php echo ($settings['searchsortorder'] == "Descending" ? 'selected=true"' : ''); ?> >Descending</option>		
		</select>
	</td>
</tr>
</table>
